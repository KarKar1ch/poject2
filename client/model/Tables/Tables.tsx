      ...
      <div className="sticky top-0 z-50 p-4 border-b border-gray-200 flex justify-between items-center bg-white shadow-sm">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="px-4 py-2 bg-blue-600 text-white rounded-[30px] hover:bg-blue-700 transition-colors duration-200 flex items-center gap-2"
          >
          ...
          <button
            ...
            className="px-4 py-2 bg-blue-600 text-white rounded-[30px] hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed transition-colors duration-200 flex items-center gap-2"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
