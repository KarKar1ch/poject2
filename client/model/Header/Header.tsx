    ...
    return(
        <header className="">
            <div className="p-[10px] w-full flex">
                <div className=" w-full"><input className="w-full bg-white rounded-[30px] border border-[#00000014] h-[45px] pl-[10px]" placeholder="Наименование, ИНН, ОРГН, Руководитель"/></div>
